...
class OTPAScreen extends StatefulWidget {
  const OTPAScreen({super.key});

  @override
  State<OTPAScreen> createState() => _OTPAScreenState();
}
    ...
    return Scaffold(
      ...
      body:Column(
        children: [
          ...
          const Text('ارسلنا كلمة السر الى هذا الرقم *** *** **99 '
              '\n\nادخل الرمز',
              style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 20,
                  color: Colors.black)),
          ...
          TextButton(onPressed:() => {if (clock()==false){null}} , child:const Text('ارسال الرمز مرة أخرى',
